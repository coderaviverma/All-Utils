package com.aw.avi.allutilsmethodsapp.ui.activity.launchmodes.singleinstance;
...
public class SingleInstanceActivity_A extends BaseActivity {

    private static final String TAG= SingleInstanceActivity_A.class.getSimpleName();
    ...
    public SingleInstanceActivity_A(){
        super();
        instanceCounter++;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.buttonStartActivityA: startActivity(this, SingleInstanceActivity_A.class);break;
