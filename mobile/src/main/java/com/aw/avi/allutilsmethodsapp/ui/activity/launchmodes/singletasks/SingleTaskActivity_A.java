package com.aw.avi.allutilsmethodsapp.ui.activity.launchmodes.singletasks;
...
public class SingleTaskActivity_A extends BaseActivity {

    private static final String TAG= SingleTaskActivity_A.class.getSimpleName();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.buttonStartActivityA: startActivity(this, SingleTaskActivity_A.class);break;
