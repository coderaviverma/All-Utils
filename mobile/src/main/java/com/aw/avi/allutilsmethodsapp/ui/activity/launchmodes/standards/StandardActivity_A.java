package com.aw.avi.allutilsmethodsapp.ui.activity.launchmodes.standards;
...
public class StandardActivity_A extends BaseActivity {

    private static final String TAG= StandardActivity_A.class.getSimpleName();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.buttonStartActivityA: startActivity(this, StandardActivity_A.class);break;
